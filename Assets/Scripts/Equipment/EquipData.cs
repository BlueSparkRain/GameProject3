...
public class EquipData : IValidatable
{
    ...
    public EquipData(string equipId, E_EquipmentSlot slot, EquipAffix[] affixes, E_WeaknessType weakness, int chaosLevel, int price, string equipName = "")
    {
