...
public class CharacterBattle_Controller : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        bool isplayer = (characterType == E_CharacterType.P_1 ||
                         characterType == E_CharacterType.P_2 ||
                         characterType == E_CharacterType.P_3 );

        GetComponentInChildren<CharacterBattleSkillHandler>().BattleSkiller.InitSkiller(isplayer,this);
        GameRoot.GetManager<BattleTargetsSelectManager>().RegisterSkiller(isplayer,this);
