using System;
public static class DamageCalculateManager
{
    /// <summary>
    /// 攻击方造成的初始伤害
    /// 公式:(基础攻击力*技能倍率)*其他修正
    ...
    {
        //攻击方造成一定数值的伤害
        return _otherMulitiRate.Invoke(_baseAttack * _skillMultiRate);
    }
    ...
    /// <returns></returns>
    public static float GetFinalDamage(float _damageValue, float _resistanceRate, Func<float, float> _otherMulitiRate)
    {
        return _otherMulitiRate.Invoke(_damageValue * (1 - _resistanceRate));
    }
